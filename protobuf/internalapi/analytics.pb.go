...
func (x *VoterBucketsResponse) GetBuckets() []uint64 {
	if x != nil {
		return x.Buckets
	}
	return nil
...
var file_protobuf_internalapi_analytics_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x64, 0x61, 0x6f, 0x49, 0x64, 0x22, 0x30,
	...
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x04, 0x52, 0x07, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x73,
	0x32, 0xcd, 0x01, 0x0a, 0x09, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x73, 0x12, 0x68,
	...
	0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x3b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x61, 0x70,
...
var file_protobuf_internalapi_analytics_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_protobuf_internalapi_analytics_proto_depIdxs = []int32{
	5, // 0: internalapi.MonthlyActiveUsers.period_started:type_name -> google.protobuf.Timestamp
	...
	3, // 3: internalapi.Analytics.GetVoterBuckets:input_type -> internalapi.VoterBucketsRequest
	2, // 4: internalapi.Analytics.GetMonthlyActiveUsers:output_type -> internalapi.MonthlyActiveUsersResponse
	4, // 5: internalapi.Analytics.GetVoterBuckets:output_type -> internalapi.VoterBucketsResponse
