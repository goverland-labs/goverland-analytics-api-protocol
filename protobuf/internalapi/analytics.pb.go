...
type Bin struct {
	...
	UpperBound uint32 `protobuf:"varint,1,opt,name=upper_bound,json=upperBound,proto3" json:"upper_bound,omitempty"`
...
func (x *Bin) GetUpperBound() uint32 {
	if x != nil {
		return x.UpperBound
	}
	return 0
...
var file_analytics_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x72, 0x5f, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
